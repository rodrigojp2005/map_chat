...
<div class="container mx-auto px-4 py-8">
    ...
    <script>
        document.getElementById('btn-compartilhar').onclick = function() { document.getElementById('modal-compartilhar').style.display = 'flex'; };
...
<script>
    function initMapShow() {
        ...
        const mapShow = new google.maps.Map(document.getElementById('map-show'), { center: location, zoom: 15 });
        new google.maps.Marker({ position: location, map: mapShow });
        const streetViewShow = new google.maps.StreetViewPanorama(document.getElementById('street-view-show'), { position: location, pov: { heading: 165, pitch: 0 }, zoom: 1 });
    }
